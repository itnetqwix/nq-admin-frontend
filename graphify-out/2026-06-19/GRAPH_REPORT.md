...
## Corpus Check
- 316 files · ~520,268 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1385 nodes · 1763 edges · 199 communities (148 shown, 51 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc9d3404`
...
5. `requireApiBaseUrl()` - 19 edges
6. `parseJson()` - 16 edges
7. `apiUrl()` - 16 edges
8. `apiUrl()` - 15 edges
9. `getAuthHeaders()` - 15 edges
10. `postFinance()` - 15 edges
...
- `CmsBlogPage()` --calls--> `useAdminConfirm()`  [INFERRED]
  src/pages/apps/cms-blog/index.jsx → src/components/admin/useAdminConfirm.js
- `CmsLegalPage()` --calls--> `useAdminConfirm()`  [INFERRED]
  src/pages/apps/cms-legal/index.jsx → src/components/admin/useAdminConfirm.js
...
Cohesion: 0.10
Nodes (6): VARIANT_META, defaultSx, ADMIN_LIST_GRID_HEIGHT, AdminLoadingState(), AdminMasterDetailSkeleton(), INITIAL
...
Cohesion: 0.37
Nodes (17): apiUrl(), createCmsPage(), deleteCmsPage(), getAdminFaq(), getAuthHeaders(), getCmsSummary(), handleRes(), listCmsPages() (+9 more)
...
Cohesion: 0.04
Nodes (37): BlankLayoutAppBar(), LinkStyled, adminRegisterEnvHint(), isAdminRegisterEnabled(), showAdminMfaNotice(), ColorBox, Customizer(), CustomizerSpacing (+29 more)
...
Cohesion: 0.28
Nodes (5): fmt(), SessionTimelinePanel(), BookingDetailDrawer(), refundTransferLabel(), isCurrentDateBefore()
...
Cohesion: 0.12
Nodes (29): apiUrl(), createBanner(), deleteBanner(), getAuthHeaders(), handleRes(), listBanners(), toggleBanner(), updateBanner() (+21 more)

### Community 35 - "Services Verificationapi"
Cohesion: 0.50
Nodes (3): LibrarySubmissionsPanel(), proposedLabel(), STATUS_TABS
...
Cohesion: 0.40
Nodes (4): StudentDetail(), AdminUser360Tabs(), safeImg(), getImageUrl()
...
Cohesion: 0.14
Nodes (6): AccountDeletionsPage(), STATUS_COLOR, useAdminConfirm(), ClipTaxonomyPanel(), ManageTrainee(), NetqwixLibraryPage()
...
Cohesion: 0.50
Nodes (3): STATUS_COLORS, TYPE_FILTERS, UsersDirectoryPage()

### Community 58 - "Ops Logs Index"
Cohesion: 0.67
Nodes (3): CATEGORIES, OpsLogsPage(), severityColor()
...
Cohesion: 0.50
Nodes (3): CmsLegalPage(), SLUGS, WRITING_TIPS
...
Cohesion: 0.12
Nodes (6): ExtraInfoTree(), formatPrimitive(), RATING_FIELD_LABELS, tabLabels, timelineDotBg(), timelineDotColor()
...
## Knowledge Gaps
- **434 isolated node(s):** `editor.defaultFormatter`, `editor.defaultFormatter`, `source.fixAll.eslint`, `source.organizeImports`, `editor.defaultFormatter` (+429 more)
...
- **Why does `useAuth()` connect `Auth Guards & Middleware` to `Blank Layout With`, `Content Contentplacementconfig`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `useAdminConfirm()` connect `Account Deletions Index` to `Services Verificationapi`, `Pricing Analytics UI`, `Finance Index`, `Promo Codes Index`, `Broadcasts Index`, `Cms Blog Index`, `Cms Faq Index`, `Cms Legal Index`, `Admin Admindatagrid`, `Customizer Index`, `Banners Index`, `NetQwix Library Index`, `Ops Logs Index`, `Services Bannersapi`, `Content Contentplacementconfig`?**
