...
export default function OpsHealthTab({ hub = false, refreshTick = 0 }) {
            ...
            <Grid container spacing={1.5}>
              <Grid item xs={12} sm={4}>
                <OpsMetricTile
                  ...
                  onClick={() => router.push('/apps/ops?tab=events&severity=critical&resolution=open')}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
                <OpsMetricTile
                  ...
                  onClick={() => router.push('/apps/ops?tab=events&instant_only=true')}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
                <OpsMetricTile
                  ...
                  hint='Diagnostics'
                  onClick={() => router.push('/apps/ops?tab=calls')}
                />
              </Grid>
            </Grid>
          )}
      ...
      <OpsSurfaceCard>
        ...
        <Stack direction='row' spacing={1} flexWrap='wrap' useFlexGap>
          {[
            ...
            ['/apps/ops?tab=events', 'Ops events'],
            ['/apps/platform-activity', 'Activity'],
            ['/apps/ops?tab=calls', 'Call diagnostics'],
